...
-keep class [com.app.abby.perfectweather].** { *; }
...
-keep public class [com.app.abby.perfectweather].R$*{
...
-keep class com.app.abby.tsnackbar.** { *; }
-dontwarn com.app.abby.tsnackbar.**


-keep class com.jaeger.statusbarutil.** { *; }
-dontwarn com.jaeger.statusbarutil.**

-keep class com.litesuits.orm.** { *; }
-dontwarn com.litesuits.orm.**
-keep interface com.litesuit.orm**
